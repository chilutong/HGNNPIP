...
def compute_test():
    ...
    classifier_output = torch.tensor(classifier_output)
    classifier_output=classifier_output.cuda()


    acc_test = accuracy(classifier_output, labels[idx_test],
                        args.threshold)
    precision, recall,spec, f1, mcc, roc, ap = metric(classifier_output,
